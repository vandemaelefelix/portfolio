            ...
            projectsContent.push(
                ...
                >
                    <div data-test={'nothing'} className={`${styles.project}`}>
                        ...
                        <div data-test={'nothing'} className={`${styles.imageContainer}`}>
                            <svg
                                ref={(element) => {
                            ...
                            <div data-test={'nothing'} className={`${styles.imageWrapper}`}>
                                <Image
                            ...
                            <div data-test={'nothing'} className={styles.imageOverlay}></div>
                            <svg
                                ref={(element) => {
                                    if (parrallaxRefs.current) {
                                        parrallaxRefs.current[parrallaxRefs.current.length + 1] = {
                ...
                // <div  data-test={'nothing'} key={project.id}>
                // </div>
            );
        });
