...
export default function Contact() {
    ...
    const buttonContainerRef: any = useRef();
    ...
    const handleSocialClick = (social: string) => {
        switch (social) {
            case 'github':
                window.open('https://github.com/vandemaelefelix', '_blank');
                break;
            case 'codepen':
                // window.location.href = '';
                window.open('https://codepen.io/felixvandemaele1', '_blank');
                break;
            case 'linkedin':
                // window.location.href = '';
                window.open('https://www.linkedin.com/in/felix-vandemaele-554949193', '_blank');
                break;
        }
    };
        ...
        <section id={'contactSection'} className={`${styles.contactSection}`}>
            ...
            <div className={`${styles.content}`}>
                ...
                <div
                    onClick={() => {
                        setTimeout(() => {
                            window.location.href = 'mailto:vandemaelefelix@gmail.com';
                        }, 1000);
                    }}
                    tabIndex={0}
                    className={styles.hireButtonContainer}
                >
                    <div
                        ref={(element) => {
                    ...
                    >
                        <p>
                            Send email
                            <span>
                                <svg viewBox="0 0 21.954 20.768">
                                    <path
                                        d="M1.513,1.96a1.374,1.374,0,0,1,1.5-.21l19.335,9.215a1.146,1.146,0,0,1,0,2.07L3.012,22.25a1.374,1.374,0,0,1-1.947-1.46L2.49,12,1.065,3.21a1.374,1.374,0,0,1,.448-1.25ZM3.888,12.75l-1.3,8.042L21.031,12,2.584,3.208l1.3,8.042H11.25a.75.75,0,0,1,0,1.5Z"
                                        transform="translate(-1.047 -1.616)"
                                        fillRule="evenodd"
                                    />
                                </svg>
                            </span>
                    ...
                    <Parrallax container={null} parrallaxRefs={buttonRef}></Parrallax>
                </div>
                ...
                <div className={`${styles.infoContainer}`}>
                    ...
                    >
                        ...
                        <p className={`${styles.copiedEmailText}`}>
                            copied
                            <span>
                                <svg viewBox="0 0 418.549 320.193">
                                    <path
                                        d="M-9309-3526.472l124.872,124.872,240.644-240.644"
                                        transform="translate(9335.517 3668.76)"
                                        strokeLinecap="round"
                ...
                <div data-mouse={'hide'} className={`${styles.socials}`}>
                    <div onClick={() => handleSocialClick('github')} className={`${styles.socialsItem}`}>
                        <div data-mouse={'hide'}>
                    ...
                    <div onClick={() => handleSocialClick('codepen')} className={`${styles.socialsItem}`}>
                        <div data-mouse={'hide'}>
                    ...
                    <div onClick={() => handleSocialClick('linkedin')} className={`${styles.socialsItem}`}>
                        <div data-mouse={'hide'}>
                            <svg viewBox="0 0 50 50">
